...
import ManageLogin from './Components/Admin/pages/ManageLogin';
...
import ManageLogout from './Components/Admin/pages/ManageLogout';
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/admin-dashboard/manage-login' element={<ManageLogin />}/>
        ...
        <Route path='/admin-dashbord/admin-logout' element={<Logout />}/>
        <Route path='/admin-dashboard/manage-logout' element={<ManageLogout />}/>
      </Routes>
    </BrowserRouter>
  </React.StrictMode>
);
