...
export default function UpdateArrivedProduct() {
  ...
  useEffect(()=> {
    axios.get(BASE_URL+`justarrivedproduct/${id}`)
    .then((res) => {
  ...
  const UpdateData = () =>{
      ...
      var insert = {
          ...
          axios.put(BASE_URL+`justarrivedproduct/${id}`, insert)
          .then(()=>{
              Swal.fire({
                icon: 'success',
                title: 'Updated',
              ...
              Navigate("/admin-dashboard/manage-arrived-products")
          })
  }
      ...
      <AdminHeader />
            ...
            <div className="trendyproducts p-5">
                <div className="container m-0 p-0">
                    <h1 className='text-center'>Update Arrived Products Here</h1>
