          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item">
              <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link to="/admin-dashboard/manage-login" className="dropdown-item">Login</Link></li>
                  <li><Link to="/admin-dashboard/manage-register" class="dropdown-item">Register</Link></li>
                  <li><Link to="/admin-dashboard/manage-logout" class="dropdown-item">Logout</Link></li>
                </ul>
              </div>
            </li>
            <li className="nav-item">
